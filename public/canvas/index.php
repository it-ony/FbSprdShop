...
$config = array(
    "appId" => "206748646126990",
    "secret" => ""
);

require_once "lib/sprd/controller/CanvasController.php";
$shopSetup = new CanvasController($config);
$user = $shopSetup->handleRequest();
...
<head>
    ...
    <script type="text/javascript" src="installer/js/lib/require.js" data-usage="lib"></script>
    <script type="text/javascript" src="installer/js/lib/rAppid.js" data-usage="lib"></script>
...
<script type="text/javascript" data-usage="bootstrap">
    rAppid.bootStrap("app/FbInstaller.xml", document.body, {
        ...
        region: "<?php echo $user->getRegion(); ?>"
    }, {
        baseUrl: "installer",
